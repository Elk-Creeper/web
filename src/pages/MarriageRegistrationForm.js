      ...
      <div className="section">
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.h_fname}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.h_lname}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.h_placeBirth}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.h_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Husband's Residence</label>
            <div className="placeholder">{selectedItem.h_residence}</div>
          </div>

          <div className="form-group">
            <label>Husband's Religion/Religious Sect</label>
            <div className="placeholder">{selectedItem.h_religion}</div>
          </div>

          <div className="form-group">
            <label>Husband's Civil Status</label>
            <div className="placeholder">{selectedItem.h_civilstat}</div>
          </div>

          <div className="form-group">
            <label>Husband's Name of Father</label>
            <div className="placeholder">{selectedItem.h_fatherName}</div>
          </div>

          <div className="form-group">
            <label>Husband's Father Citizenship</label>
            <div className="placeholder">{selectedItem.hf_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Husband's Mother's Maiden Name</label>
            <div className="placeholder">{selectedItem.h_motherName}</div>
          </div>

          <div className="form-group">
            <label>Husband's Mother Citizenship</label>
            <div className="placeholder">{selectedItem.hm_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Name of Person/Wali who gave Consent or Advice</label>
            <div className="placeholder">{selectedItem.h_personName}</div>
          </div>

          <div className="form-group">
            <label>Relationship</label>
            <div className="placeholder">{selectedItem.h_relationship}</div>
          </div>

          <div className="form-group">
            <label>Residence</label>
            <div className="placeholder">{selectedItem.hp_residence}</div>
          </div>
      ...
      <div className="section">
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.w_fname}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.w_lname}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.w_placeBirth}</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.w_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Wife's Residence</label>
            <div className="placeholder">{selectedItem.w_residence}</div>
          </div>

          <div className="form-group">
            <label>Wife's Religion/Religious sect</label>
            <div className="placeholder">{selectedItem.w_religion}</div>
          </div>

          <div className="form-group">
            <label>Wife's Civil Status</label>
            <div className="placeholder">{selectedItem.w_civilstat}</div>
          </div>

          <div className="form-group">
            <label>Wife's Name of Father</label>
            <div className="placeholder">{selectedItem.w_fatherName}</div>
          </div>

          <div className="form-group">
            <label>Wife's Father Citizenship</label>
            <div className="placeholder">{selectedItem.wf_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Wife's Mother Maiden Name</label>
            <div className="placeholder">{selectedItem.w_motherName}</div>
          </div>

          <div className="form-group">
            <label>Wife's Mother Citizenship</label>
            <div className="placeholder">{selectedItem.wm_citizenship}</div>
          </div>

          <div className="form-group">
            <label>Name of Person/Wali who gave Consent or Advice</label>
            <div className="placeholder">{selectedItem.w_personName}</div>
          </div>

          <div className="form-group">
            <label>Relationship</label>
            <div className="placeholder">{selectedItem.w_relationship}</div>
          </div>

          <div className="form-group">
            <label>Residence</label>
            <div className="placeholder">{selectedItem.wp_residence}</div>
          </div>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="form-grid">
          <div className="form-group">
            ...
            <div className="placeholder">{selectedItem.w_placeMarriage}</div>
          </div>
