...
const generateBirthRegistrationForm = (
  ...
  pdfDoc.text(`${c_fname ? c_fname.toUpperCase() : ""}`, 58, 57);
  ...
  pdfDoc.text(uppercasedMiddleName, 106, 57);
  ...
  pdfDoc.text(`${c_lname ? c_lname.toUpperCase() : ""}`, 162, 57);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${sex ? sex.toUpperCase() : ""}`, 37, 68);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${birthplace ? birthplace.toUpperCase() : ""}`, 62, 80);
  // Draw a line after the word
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${typeofbirth ? typeofbirth.toUpperCase() : ""}`, 27, 90);
  // Draw a line after the word
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${c_multiple ? c_multiple.toUpperCase() : ""}`, 62, 90);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${birthorder ? birthorder.toUpperCase() : ""}`, 120, 91);
  ...
  pdfDoc.setLineWidth(formBorderWidth);
  pdfDoc.line(verticalLinessss, 47, verticalLinessss, 47 + verticalHeightssss);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${m_name ? m_name.toUpperCase() : ""}`, 70, 106);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${bornAlive ? bornAlive.toUpperCase() : ""}`, 30, 129);
  // Draw a line after the word
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${m_occur ? m_occur.toUpperCase() : ""}`, 135, 129);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  pdfDoc.text(`${m_age ? m_age.toUpperCase() : ""}`, 165, 129);
  ...
  pdfDoc.setTextColor("#000000");
  pdfDoc.setFontSize(10);
  // pdfDoc.text(`${mpDate ? mpDate.toUpperCase() : ""}`, 65, 67);
  ...
  if (attendant && attendant.toLowerCase() === "Physician") {
    // Display a check mark at the specified position (19, 207)
    pdfDoc.text("\u2713", 19, 207);
  } else {
    // Display the attendant name in uppercase
    pdfDoc.text(`${attendant ? attendant.toUpperCase() : ""}`, 19, 207);
  }
  ...
  if (
    attendant &&
    attendant.toLowerCase() === "Hilot (Traditional Birth Attendant)"
  ) {
    // Display a check mark at the specified position (19, 207)
    pdfDoc.text("\u2713", 19, 207);
  } else {
  ...
  pdfDoc.text("22. REGISTERED AT THE OFFICE OF THE CIVIL REGISTRAR ", 108, 297);
...
`;
 ...
 pdfDoc.text(affidavitTextss, 17, 85);
   ...
   pdfDoc.setFontSize(8);
   pdfDoc.text("(To be accomplished by the hospital/clinic administrator, father, mother, or guardian or the person himself if 18 years old or over.)", 27, 148);
...
`;
   ...
   pdfDoc.text("1. That I am the applicant for the delayed registration of: ", 24, 175);
   ...
   pdfDoc.text("not married but I/he/she was acknowledged/not acknowledged by ", 79, 225);
   pdfDoc.text("my/his/her fat2her whose name is", 83, 230);
   pdfDoc.line(133, 231, 196, 231);
   pdfDoc.text("5. That the reason for the delay in registering my/his/her birth was", 24, 236);
   ...
   pdfDoc.text("(if the applicant is other than the  document owner) That I am the", 28, 254);
   pdfDoc.line(120, 255, 159, 255);
   pdfDoc.text("of the said person.", 161, 254);
   pdfDoc.text("7. That I am executing this affidavit to attest to the truthfulness of the foregoing statements for all legal", 24, 260);
   pdfDoc.text("intents and purposes.", 28, 264);
   pdfDoc.text("In  truth  whereof, I  have  affixed  my  signature  below  this", 24, 275);
   ...
   pdfDoc.text("affiant  who  exhibited  to  me  his/her  CTC/valid  ID", 100, 315);
