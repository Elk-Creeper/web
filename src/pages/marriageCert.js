...
import { generateMarriageCertificateForm } from "./pdfs";
...
function App() {
  ...
  const openPDFFile = async () => {
    try {
      // Assuming you have a valid URL for the PDF file, replace 'pdfFileUrl' with the actual URL
      const pdfUrl =
        pdfFileUrl ||
        "https://firebasestorage.googleapis.com/v0/b/muniserve-4dc11.appspot.com/o/pdfs%2FCertificate-of-Live-Birth-COLB%20(1).pdf?alt=media&token=4a71ade6-e644-42ad-9d41-f314f575b36e";
          ...
          <div className="details-content">
            <div className="subheads">
              <div className="request-item">
                ...
                <p>
                  This registration form is requested by {selectedItem.m_name}.
                </p>
                ...
                <div className="buttons">
                  ...
                  <div className="open-pdf-button-container">
                    <button onClick={openPDFFile}>Open PDF File</button>
                    <button onClick={generateCustomizedForm}>
                      Generate Form
                    </button>
                  </div>
                </div>
